...
const codaLinks = [
    {
      name: "Marc",
      ghRepoURL: "https://github.com/marcwright/codacade",
      ghPagesURL: "https://marcwright.github.io/codacade/"
    },
    {
      name: "Schmitty",
      ghRepoURL: "https://github.com/marcwright/codacade",
...
codaLinks.forEach(coda => {
  let $newCard = $(`<div class="col-md-4">
                      <div class="card mb-4 box-shadow">
                          ...
                          <div class="card-body">
                              <p class="card-text pressStartFont">${coda.name}</p>
                              <div class="d-flex justify-content-between align-items-center">
                                  <div class="btn-group">
                                      <a href="${coda.ghRepoURL}" class="btn btn-primary btn-sm active" target="_blank" role="button" aria-pressed="true">GitHub Repo</a>
                                      <a href="${coda.ghPagesURL}" class="btn btn-secondary btn-sm active" role="button" target="_blank" aria-pressed="true">Live Link</a>
                                  </div>
                              </div>
                          </div>
                      </div>
